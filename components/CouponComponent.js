...
class Coupon extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
          ...
          userSelected:[],
          data: [
            {id:1,  name: "Eggs", price: 0.60, image:"https://www.incnow.com/wp-content/uploads/2013/03/egg-carton.jpg"},
            {id:2,  name: "Milk",  price: 0.75, image:"https://shepherdminiatures.com/wp-content/uploads/2018/02/milk-red-small-copy.jpg"},
            {id:3,  name: "Bread",  price: 0.55, image:"https://americacomesalive.com/i/Wonder-bread.png"} ,
            {id:4,  name: "Cheese",  price: 0.25, image:"http://www.diningchicago.com/blog/wp-content/uploads/2012/10/Kraft-cheese.png"} ,
            {id:5,  name: "Potatoes",  price: 0.99, image:"https://www.agric.wa.gov.au/sites/gateway/files/W07_0018_White_star_potato.JPG" },           
